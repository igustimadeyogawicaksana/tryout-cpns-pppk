...
Tahap ini menghitung hasil tersimpan dalam satu transaksi baca SQLite pada setiap permintaan. Belum memakai generasi snapshot persisten, pembaruan 60 detik. Karena itu masih untuk skala awal dan belum dinyatakan siap beban besar. Filter provinsi tersedia dengan domisili yang dibekukan saat mulai. Invalidasi/koreksi hasil, status final dan retake belum tersedia; UI tetap memberi label sementara. Tidak ada gateway atau paket berbayar yang diaktifkan oleh fitur ini.
...
Peserta mengisi nama/provinsi opsional pada /profil. Provinsi disalin pada saat pertama bergabung dan tidak diubah jika profil berikutnya berubah. Entri lama tanpa provinsi hanya masuk ranking umum. Filter wilayah diterapkan sebelum perhitungan rank; pagination dan posisi saya memakai wilayah yang sama. Lokasi tidak diverifikasi. Label provinsi mengacu [tabel BPS menurut provinsi](https://www.bps.go.id/id/statistics-table/2/ODU2IzI=/persentase-rumah-tangga-menurut-provinsi-tipe-daerah-dan-sumber-penerangan-listrik-pln.html), diperiksa 2026-09-11; kunci slug adalah pengenal internal aplikasi, bukan kode wilayah resmi.

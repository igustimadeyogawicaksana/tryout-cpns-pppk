...
Gunakan satu database utama SQLite untuk MVP. Lihat [rencana self-hosting](mvp-self-hosting.md). Tujuan backup yang disebut pengguna sebagai “r 1” belum teridentifikasi; Cloudflare R2 belum ditetapkan.

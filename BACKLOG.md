...
| AUTH-003 | P1 | Daftar email, verifikasi dan pemulihan password | In progress | AUTH-001 | Form dan backend tersedia, outbox lokal serta uji HTTP; perlu SMTP nyata dan uji pengiriman produksi |

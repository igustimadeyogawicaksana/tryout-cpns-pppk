...
| PROD-002 | P0 | Nama, harga, masa akses dan percobaan | In progress | — | Pedoman tersedia; fase pengembangan masih mengizinkan retake gratis, sedangkan pembatasan satu percobaan gratis dan kuota percobaan produk masih perlu diimplementasikan sebelum rilis |
...
| UX-002 | P1 | Validasi lintas perangkat/browser | In progress | USER-001 | Katalog dan ujian 320 px diperiksa di browser aplikasi; navigasi soal stabil, nomor per subtes, label topik dan SVG figural tersedia. Matriks Chrome/Edge/Firefox/Safari, tablet, landscape dan perangkat fisik masih perlu diuji |
...
| PAY-003 | P1 | Checkout dan verifikasi pembayaran | Done — lokal | AUTH-001, CONTENT-001, PAY-002 | Bukti terstruktur dan audit review, nominal, kedaluwarsa, retry, persetujuan/penolakan, grant dan pencabutan akses teruji; QRIS/merchant produksi ditunda |
...
| RANK-001 | P1 | Ranking dasar umum dan provinsi | Done — lokal | EXAM-001, RESULT-001 | Ranking umum/provinsi, satu sesi kompetisi, seri, alias/opt-out, pagination dan snapshot final persisten teruji |
| RANK-002 | P1 | Koreksi penilaian dan finalisasi ranking | Done — lokal | RANK-001 | Revisi hasil memakai optimistic lock dan audit sebelum/sesudah; policy dibekukan per attempt dan cohort campuran ditolak; setiap koreksi membuat snapshot generasi baru tanpa menimpa generasi lama; UI admin dan konsistensi hasil/ranking teruji |
| RESULT-001 | P1 | Hasil dan pembahasan dasar | Done — lokal | EXAM-001, PROD-001 | Ringkasan hasil tetap tersedia; pembahasan kompetisi menunggu penutupan dan pembahasan berbayar memerlukan grant aktif; akses kedaluwarsa/dicabut teruji |
...
| CONTENT-005 | P1 | Perbaikan isi trial dan sinkronisasi opsi/skor | Done — lokal | CONTENT-003 | Edisi baru 30 TWK, 35 TIU, 45 TKP; pemeriksaan duplikasi tanpa nomor; 550 opsi konsisten; hasil 550/45/0 teruji; sesi lama tidak ditimpa. Review editor manusia sebelum produksi masih diperlukan |

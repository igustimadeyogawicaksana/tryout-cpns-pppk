...
| PAY-003 | P1 | Checkout dan verifikasi pembayaran | In progress | AUTH-001, CONTENT-001, PAY-002 | Endpoint, halaman pembayaran peserta, verifikasi admin, idempotensi, grant akses, dan pembatasan mesin ujian tersedia; uji HTTP dengan produk aktif masih tersisa |

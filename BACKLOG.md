...
| PAY-003 | P1 | Checkout dan verifikasi pembayaran | In progress | AUTH-001, CONTENT-001, PAY-002 | Endpoint order manual, pengiriman bukti, verifikasi admin, idempotensi dan grant akses tersedia; UI checkout/admin dan uji HTTP masih tersisa |
